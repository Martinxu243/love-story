  ...
  return (
    <div className="min-h-[100dvh] bg-warm-base">
      ...
      <div className="px-4 pt-6">
        <div className="relative rounded-card overflow-hidden border border-[#e8e0d5]"
          style={{ background: "linear-gradient(135deg, #e8ecf0 0%, #dce4ec 30%, #e0e8f0 60%, #d8e0e8 100%)", height: "240px" }}>
